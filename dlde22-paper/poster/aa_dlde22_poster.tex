...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Take-home message: what your step size}{headerFontColor=red,name=abstract,span=2,column=0,row=0}{
  \begin{citemize}
  ...
  \item  However adaptive solvers cannot be seamlessly
  ...
  \item By taking the Lorenz'63 system as a showcase,  a naive application
    ...
    results. 
  \item Moreover, a simple workaround is proposed that assumes a
